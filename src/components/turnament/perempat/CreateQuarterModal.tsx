...
export default function CreateQuarter() {
  ...
  // ================= TITLE =================
  useEffect(() => {
    setPageTitle(t("create") + " " + t("perempat"));
  }, [setPageTitle, t]);
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const payload = {
        babak: "perempat_final", // 🔥 wajib ada
      ...
      setTimeout(() => {
        navigate("/pertandingan/perempat-final");
      }, 1500);
            ...
            <Box display="flex" flexDirection="column" gap={2} mt={2} ml={4} mr={4}>
              ...
              <Box display="flex" justifyContent="flex-end" gap={2}>
                ...
                <Button
                  variant="contained"
                  color="warning"
                  onClick={() => navigate("/pertandingan/perempat-final")}
                >
                  {t("back")}
                </Button>
